...
let question2 = new Question(`2Vous rassasie-t-il jusqu’au repas du midi? `, ["oui", "non"],2);
quiz.addQuestion(question2);
let question3 = new Question(`3Est-il équilibré ?`, ["oui", "non"],2);
quiz.addQuestion(question3);
let question4 = new Question(`4Pratiquez vous une/des activité(s) sportive(s) ?Et si oui à quelle fréquese
(Dans le cas d'une pratique sportive un petit-déjeuner est fortement conseillé)
`, ["Très souvent ", "Régulièrement ","De temps en temps", "Ne pratique pas"],2);
quiz.addQuestion(question4);
let question5 = new Question(`5Changez-vous vos habitudes le matin ?`, ["oui", "non"],2);
quiz.addQuestion(question5);
let question6 = new Question(`6Selon vous, quel est le repas le plus équilibré de la journée ?`, ["Petit déjeuner","Repas du midi", "Colation","Dinner"],2);
quiz.addQuestion(question6);

let question7 = new Question(`-Prenez-vous habituellement un goûter à la pause du matin de 9h40 à 9h50 ?`,["non","oui"],2);
...
let question1_2 = new Question(`Vers quelle heure commencez-vous à avoir faim ?`, ["7h-8h","8h-9h", "9h-10h", "10h-11h","11h-12h"], 3);
quiz2.addQuestion(question1_2);
let question2_2 = new Question(`Pourquoi n’en prenez vous pas ?`, ["Pas le temps", "pas d'idée" , "pas d'argent", " Ne vois pas la nécessité" , "autres raison" ], 2);
quiz2.addQuestion(question2_2);
let question3_2 = new Question(`Pratiquez vous une/des activité(s) sportive(s) ?Et si oui à quelle fréquese`, ["Très souvent ", "Régulièrement ","De temps en temps", "Ne pratique pas"],2);
quiz2.addQuestion(question3_2);
let question4_2 = new Question(`Vers quelle heure commencez-vous à avoir faim ?`, ["7h-8h","8h-9h", "9h-10h", "10h-11h","11h-12h"], 3);
quiz2.addQuestion(question4_2);
let question5_2 = new Question(`2Vous rassasie-t-il jusqu’au repas du midi?`, ["oui", "non"], 2);
quiz2.addQuestion(question5_2);
let question6_2 = new Question(`3Est-il équilibré ?`, ["bon", "trop salé", "je n'ai pas mangé"], 2);
quiz2.addQuestion(question6_2);
